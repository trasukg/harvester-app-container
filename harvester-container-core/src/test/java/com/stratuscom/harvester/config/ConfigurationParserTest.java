...
package com.stratuscom.harvester.config;
...
import com.stratuscom.harvester.config.ContainerConfig;
...
public class ConfigurationParserTest {
    ...
    public void setUp() throws JAXBException, SAXException {
        ctx = JAXBContext.newInstance("com.stratuscom.harvester.config");
